class UserMailer < ActionMailer::Base
  ...
  def send_mail_visitor(visitor_obj , userrestaurantvisitor,media_visitors,fact_message,menu_message,menu_item_message,a_la_minute_message ,newsfeed_message,trace_keywords)
    ...
    body        :userrestaurantvisitor => userrestaurantvisitor, :media_visitors => media_visitors,:visitor_obj => visitor_obj,:fact_message => fact_message, :menu_message => menu_message,:menu_item_message => menu_item_message,:a_la_minute_message => a_la_minute_message, :newsfeed_message => newsfeed_message,:trace_keywords=>trace_keywords
  end

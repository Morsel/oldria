class Restaurants::NewslettersController < ApplicationController
  ...
  def index
    ...
    @message = "Make the most of the content you upload to Spoonfeed with our automated diner newsletter - include in your subscription ! Its the easiest way to stay connected with your diners so they come back for more! Get started today." if (@restaurant.account_type == "Premium" || @restaurant.account_type == "Complimentary Premium") && (@restaurant.restaurant_newsletters.empty? == true)

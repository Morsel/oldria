class Restaurants::NewslettersController < ApplicationController
  ...
  def index
    ...
    @message = "Make the most of the content you upload to Spoonfeed with our automated diner newsletter — included in your subscription! It's the easiest way to stay connected with your guests so the dine more often! Get started today!." if (@restaurant.account_type == "Premium" || @restaurant.account_type == "Complimentary Premium") && (@restaurant.restaurant_newsletters.empty? == true)

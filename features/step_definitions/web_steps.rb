...
When /^Visit to front_burner$/ do
  visit 'soapbox/front_burner'
end
...
Then /^I see more link to the answer's expanded view$/ do
  link = user_questions_url(@profile_answer.user, :chapter_id => @profile_answer.profile_question.chapter.id,

  ...
  default_url_options[:host] = DEFAULT_HOST
	...
	def send_notification
      ...
      Restaurant.all.each do |restaurant|
        if restaurant.visitor_email_setting.is_approved && Time.now > restaurant.visitor_email_setting.next_email_at
          ...
          unless visitor.blank?
            ...
            UserMailer.deliver_send_mail_visitor(visitor,visitors,media_visitors,@fact_message,@menu_message,@menu_item_message,@a_la_minute_message,@newsfeed_message) unless media_visitors.blank?

ActionController::Routing::Routes.draw do |map|
  ...
  map.namespace :admin do |admin|
    ...
    admin.resources :profile_questions, :collection => { :manage => :get, :sort => :post, :topic => :any, :chapter => :any }
    ...
    map.admin_chapter 'admin/profile_questions/chapter/:id', :controller => "admin/profile_questions", :action => "chapter"
